package iooojik.ru.phoneblocker.services
...
import iooojik.ru.phoneblocker.MainActivity
...
class CallControlService : InCallService() {
    ...
    private fun sendNotification(title: String, text: String){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            createNotificationChannel(StaticVars().NOTIFICATION_ID.toString(), StaticVars().NOTIFICATION_NAME);
        }
